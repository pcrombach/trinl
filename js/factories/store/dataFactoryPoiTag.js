...
trinl.factory('dataFactoryPoiTag', ['loDash', '$timeout', '$rootScope', 'dataFactoryStore', 'dataFactoryAlive',
  function (loDash, $timeout, $rootScope, dataFactoryStore, dataFactoryAlive) {

    //console.warn('dataFactoryPoiTag');

    var dataFactoryPoiTag = {};
    var me = dataFactoryPoiTag;
 ...
 */
    ...
    me.Model = function (config) {
      ...
      if (config.yprive === true) {
        this.yprive.value = true;
      }
      this.groepenId = {
      ...
      unsetAll: function () {
        ...
        loDash.each(m, function (field) {
          if (field !== true && field !== false) {
            //console.log('poitag unsetAll m, field: ', m, field);
            field.dirty = false;
          }
        });
        var Id = m.get('Id');
    ...
    me.storeInit = function () {
      return dataFactoryStore.storeInit(dataFactoryPoiTag);
    };
    ...
    me.init = function () {
      //console.warn('dataFactoryPoiTag init');
      me.fsReady = false;
      me.loaded = false;
      me.star = [];
      me.nieuw = [];
