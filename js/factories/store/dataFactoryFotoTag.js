...
trinl.factory('dataFactoryFotoTag', ['loDash', 'dataFactoryStore', 'dataFactoryAlive',
  function (loDash, dataFactoryStore, dataFactoryAlive) {

    ////console.warn('dataFactoryFotoTag');

    var dataFactoryFotoTag = {};
    var me = dataFactoryFotoTag;
      ...
      unsetAll: function () {
        ...
        loDash.each(m, function (field) {
          if (field !== true && field !== false) {
            //////console.log('fototag unsetAll m, field: ', m, field);
            field.dirty = false;
          }
        });
        var Id = m.get('Id');
    ...
    me.init = function () {
      //console.warn('dataFactoryFotoTag init');
      me.fsReady = false;
      me.loaded = false;
      me.star = [];
      me.nieuw = [];
