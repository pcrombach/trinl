...
trinl.factory('dataFactoryTrackReactie', ['loDash', 'dataFactoryStore', 'dataFactoryAlive',
  function (loDash, dataFactoryStore, dataFactoryAlive) {

    //console.warn('dataFactoryTrackReactie');

    var dataFactoryTrackReactie = {};
    var me = dataFactoryTrackReactie;

    me.storeId = 'trackreactie';
    ...
    me.Model = function (config) {
      ...
      this.trackGebruikerId = {
        value: config.trackGebruikerId || '',
        dirty: false,
        type: 'string'
      };
      this.gebruikerNaam = {
      ...
      unsetAll: function () {
        ...
        loDash.each(m, function (field) {
          if (field !== true && field !== false) {
            //console.log('trackreactie unsetAll m, field: ', m, field);
            field.dirty = false;
          }
        });
        var Id = m.get('Id');
    ...
    me.init = function () {
      //console.warn('dataFactoryTrackReactie init');
      me.fsReady = false;
      me.loaded = false;
      me.star = [];
      me.nieuw = [];
    ...
    return dataFactoryTrackReactie;
