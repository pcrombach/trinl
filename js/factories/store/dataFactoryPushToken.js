...
trinl.factory('dataFactoryPushToken', ['loDash', '$rootScope', '$timeout', '$moment', 'dataFactoryStore', 'dataFactoryAlive',
  function (loDash, $rootScope, $timeout, $moment, dataFactoryStore, dataFactoryAlive) {

    //console.warn('dataFactoryPushToken');

    var dataFactoryPushToken = {};
    var me = dataFactoryPushToken;

    me.storeId = 'pushtoken';
    ...
    me.init = function () {
      //console.warn('dataFactoryPushToken init');
      me.fsReady = false;
      me.loaded = false;
      me.star = [];
      me.nieuw = [];
