...
trinl.factory('dataFactoryTrackReactieSup', ['loDash', 'dataFactoryStore', 'dataFactoryAlive',
  function (loDash, dataFactoryStore, dataFactoryAlive) {

    //console.warn('dataFactoryTrackReactieSup');

    var dataFactoryTrackReactieSup = {};
    var me = dataFactoryTrackReactieSup;

    me.storeId = 'trackreactiesup';
      ...
      unsetAll: function () {
        ...
        loDash.each(m, function (field) {
          if (field !== true && field !== false) {
            //console.log('trackreactiesup unsetAll m, field: ', m, field);
            field.dirty = false;
          }
        });
        var Id = m.get('Id');
    ...
    me.init = function () {
      //console.warn('dataFactoryTrackReactieSup init');
      me.fsReady = false;
      me.loaded = false;
      me.star = [];
      me.nieuw = [];
    ...
    return dataFactoryTrackReactieSup;
