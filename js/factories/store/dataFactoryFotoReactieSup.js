...
trinl.factory('dataFactoryFotoReactieSup', ['loDash', 'dataFactoryStore', 'dataFactoryAlive',
  function (loDash, dataFactoryStore, dataFactoryAlive) {

    //////console.warn('dataFactoryFotoReactieSup');

    var dataFactoryFotoReactieSup = {};
    var me = dataFactoryFotoReactieSup;

    me.storeId = 'fotoreactiesup';
      ...
      unsetAll: function () {
        ...
        loDash.each(m, function (field) {
          if (field !== true && field !== false) {
            //////console.log('fotoreactiesup unsetAll m, field: ', m, field);
            field.dirty = false;
          }
        });
        var Id = m.get('Id');
    ...
    me.init = function () {
      //console.warn('dataFactoryFotoReactieSup init');
      me.fsReady = false;
      me.loaded = false;
      me.star = [];
      me.nieuw = [];
    ...
    return dataFactoryFotoReactieSup;
