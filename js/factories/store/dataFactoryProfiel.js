...
trinl.factory('dataFactoryProfiel', ['loDash', 'dataFactoryStore', 'dataFactoryAlive',
  function (loDash, dataFactoryStore, dataFactoryAlive) {

    console.warn('dataFactoryProfiel');

    var dataFactoryProfiel = {};
    var me = dataFactoryProfiel;
    ...
    me.init = function () {
      //console.warn('dataFactoryProfiel init');
      me.fsReady = false;
      me.loaded = false;
      me.star = [];
      me.nieuw = [];
