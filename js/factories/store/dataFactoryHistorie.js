...
trinl.factory('dataFactoryHistorie', ['loDash', 'dataFactoryStore', 'dataFactoryAlive',
  function (loDash, dataFactoryStore, dataFactoryAlive) {


    //console.warn('dataFactoryHistorie');

    var dataFactoryHistorie = {};
    /**
   * me = this
   */
    var me = dataFactoryHistorie;
    /**
   * Naam store
   * @type {String}
   */
    ...
    dataFactoryHistorie.init = function () {
      console.warn('dataFactoryHistorie init');
      dataFactoryHistorie.fsReady = false;
      dataFactoryHistorie.loaded = false;
      dataFactoryHistorie.star = [];
      dataFactoryHistorie.nieuw = [];
      dataFactoryHistorie.selected = [];
      dataFactoryHistorie.data = [];
      dataFactoryHistorie.store = [];
      dataFactoryHistorie.removedRecords = [];
      dataFactoryHistorie.current = '';
      dataFactoryHistorie.filters = [];
      dataFactoryHistorie.sorters = [];
      dataFactoryHistorie.actualTime = '1970-01-02 00:00:00';
      dataFactoryHistorie.lastSyncDate = '1970-01-02 00:00:00';
      dataFactoryHistorie.tmpArray = [];
    };

    return dataFactoryHistorie;
