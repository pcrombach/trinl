...
trinl.factory('dataFactoryFotoReactie', ['loDash', 'dataFactoryStore', 'dataFactoryAlive',
  function (loDash, dataFactoryStore, dataFactoryAlive) {

    //////console.warn('dataFactoryFotoReactie');

    var dataFactoryFotoReactie = {};
    var me = dataFactoryFotoReactie;

    me.storeId = 'fotoreactie';
    ...
    me.Model = function (config) {
      ...
      this.fotoGebruikerId = {
        value: config.fotoGebruikerId || '',
        dirty: false,
        type: 'string'
      };
      this.gebruikerNaam = {
      ...
      unsetAll: function () {
        ...
        loDash.each(m, function (field) {
          if (field !== true && field !== false) {
            //////console.log('fotoreactie unsetAll m, field: ', m, field);
            field.dirty = false;
          }
        });
        var Id = m.get('Id');
    ...
    me.init = function () {
      //console.warn('dataFactoryFotoReactie init');
      me.fsReady = false;
      me.loaded = false;
      me.star = [];
      me.nieuw = [];
