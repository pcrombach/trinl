...
trinl.factory('dataFactoryBerichtTag', ['loDash', 'dataFactoryStore', 'dataFactoryAlive',
  function (loDash, dataFactoryStore, dataFactoryAlive) {

    //console.warn('dataFactoryBerichtTag: ');

    var dataFactoryBerichtTag = {};
    var me = dataFactoryBerichtTag;

    /**
 * Naam store
 * @type {String}
 */
    me.storeId = 'berichttag';
      ...
      unsetAll: function () {
        ...
        loDash.each(m, function (field) {
          if (field !== true && field !== false) {
            //console.log('berichttag unsetAll m, field: ', m, field);
            field.dirty = false;
          }
        });
        var Id = m.get('Id');
