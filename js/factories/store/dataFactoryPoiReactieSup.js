...
trinl.factory('dataFactoryPoiReactieSup', ['loDash', 'dataFactoryStore', 'dataFactoryAlive',
  function (loDash, dataFactoryStore, dataFactoryAlive) {

    //console.warn('dataFactoryPoiReactieSup');

    var dataFactoryPoiReactieSup = {};
    var me = dataFactoryPoiReactieSup;

    me.storeId = 'poireactiesup';
      ...
      unsetAll: function () {
        ...
        loDash.each(m, function (field) {
          if (field !== true && field !== false) {
            //console.log('poireactiesup unsetAll m, field: ', m, field);
            field.dirty = false;
          }
        });
        var Id = m.get('Id');
    ...
    me.init = function () {
      //console.warn('dataFactoryPoiReactieSup init');
      me.fsReady = false;
      me.loaded = false;
      me.star = [];
      me.nieuw = [];
    ...
    return dataFactoryPoiReactieSup;
