...
trinl.factory('dataFactoryBerichtReactie', ['loDash', 'dataFactoryStore', 'dataFactoryAlive',
  function (loDash, dataFactoryStore, dataFactoryAlive) {

    ////console.warn('dataFactoryBerichtReactie');

    var dataFactoryBerichtReactie = {};
    var me = dataFactoryBerichtReactie;

    me.storeId = 'berichtreactie';
    ...
    me.Model = function (config) {
      ...
      this.berichtGebruikerId = {
        value: config.berichtGebruikerId || '',
        dirty: false,
        type: 'string'
      };
      this.gebruikerNaam = {
      ...
      unsetAll: function () {
        ...
        loDash.each(m, function (field) {
          if (field !== true && field !== false) {
            //console.log('berichtreactie unsetAll m, field: ', m, field);
            field.dirty = false;
          }
        });
        var Id = m.get('Id');
    ...
    me.init = function () {
      ////console.warn('dataFactoryBerichtReactie init');
      me.fsReady = false;
      me.loaded = false;
      me.star = [];
      me.nieuw = [];
    ...
    return dataFactoryBerichtReactie;
