...
trinl.factory('dataFactoryBerichtSup', ['loDash', 'dataFactoryStore', 'dataFactoryAlive', function (loDash, dataFactoryStore, dataFactoryAlive) {

  ////console.warn('dataFactoryBerichtSup');

  var dataFactoryBerichtSup = {};
  var me = dataFactoryBerichtSup;

  me.storeId = 'berichtsup';
    ...
    unsetAll: function () {
      ...
      loDash.each(m, function (field) {
        if (field !== true && field !== false) {
          ////console.log('berichtsup unsetAll m, field: ', m, field);
          field.dirty = false;
        }
      });
      var Id = m.get('Id');
