...
trinl.factory('dataFactoryTrackTag', ['loDash', '$timeout', 'dataFactoryStore', 'dataFactoryAlive',
  function (loDash, $timeout, dataFactoryStore, dataFactoryAlive) {

    //console.warn('dataFactoryTrackTag');

    var dataFactoryTrackTag = {};
    var me = dataFactoryTrackTag;
 ...
 */
      ...
      unsetAll: function () {
        ...
        loDash.each(m, function (field) {
          if (field !== true && field !== false) {
            //console.log('tracktag unsetAll m, field: ', m, field);
            field.dirty = false;
          }
        });
        var Id = m.get('Id');
    ...
    me.init = function () {
      //console.warn('dataFactoryTrackTag init');
      me.fsReady = false;
      me.loaded = false;
      me.star = [];
      me.nieuw = [];
