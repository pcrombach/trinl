...
trinl.factory('dataFactoryPoiSup', ['loDash', 'dataFactoryStore', 'dataFactoryAlive',
  function (loDash, dataFactoryStore, dataFactoryAlive) {

    //console.warn('dataFactoryPoiSup');

    var dataFactoryPoiSup = {};
    var me = dataFactoryPoiSup;
      ...
      unsetAll: function () {
        ...
        loDash.each(m, function (field) {
          if (field !== true && field !== false) {
            //console.log('poisup unsetAll m, field: ', m, field);
            field.dirty = false;
          }
        });
        var Id = m.get('Id');
    ...
    me.init = function () {
      //console.warn('dataFactoryPoiSup init');
      me.fsReady = false;
      me.loaded = false;
      me.star = [];
      me.nieuw = [];
