...
trinl.factory('dataFactoryEventLog', ['loDash', 'dataFactoryStore', 'dataFactoryAlive', function (loDash, dataFactoryStore, dataFactoryAlive) {

  //console.warn('dataFactoryEventLog');

  var dataFactoryEventLog = {};
  var me = dataFactoryEventLog;
  ...
  me.Model = function (config) {
    ...
    this.msgIdentifier = config.msgIdentifier;
    this.hostAdress = config.hostAdress;
    this.title = config.title;
    this.content = config.content;
    this.xerror = config.xerror;
    this.gebruikers_Id = config.gebruikers_Id;
  ...
  me.clearFilter = function () {
    dataFactoryStore.clearFilter(me);
  };

  me.clearSorter = function () {
    dataFactoryStore.clearSorter(me);
  };
  ...
  me.remove = function (record) {
    dataFactoryStore.remove(me, record);
  };
  ...
  me.setAutoSync = function (bool) {
    dataFactoryStore.setAutoSync(me, bool);
  };
