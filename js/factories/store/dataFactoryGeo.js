...
trinl.factory('dataFactoryGeo', [ 'loDash', 'dataFactoryStore', 'dataFactoryAlive', function( loDash, dataFactoryStore, dataFactoryAlive) {

  //console.warn('dataFactoryGeo');

  var dataFactoryGeo = {};
  var me = dataFactoryGeo;
  ...
  me.Model = function(config) {
    ...
    this.latitude = {
      value: config.latitude || 0.0,
      dirty: false,
      type: 'float'
    };
    this.longitude = {
      value: config.longitude || 0.0,
      dirty: false,
      type: 'float'
    };
  ...
  me.init = function() {
    //console.warn('dataFactoryGeo init');
    me.fsReady = false;
    me.loaded = false;
    me.star =[];
    me.nieuw = [];
